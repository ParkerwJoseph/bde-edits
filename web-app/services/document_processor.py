...
from services.processors import PDFProcessor, DOCXProcessor, XLSXProcessor, PPTXProcessor, AudioProcessor
...
class DocumentProcessor:
    ...
    - PDF: Converts pages to images for vision-based analysis
    - PPTX: Converts slides to images for vision-based analysis
    - DOCX: Extracts text using python-docx
    - XLSX: Extracts text from spreadsheet cells
    - AUDIO: Transcribes audio using Azure Whisper API
    """
    ...
    def process_document(self, file_path: str, file_type: str) -> List[dict]:
        ...
        Args:
            ...
            file_type: Type of document ('pdf', 'docx', 'xlsx')

        Returns:
            List of page/section dicts ready for LLM analysis
        """
        logger.info("=" * 60)
