...
Revision ID: 003_add_connector_permissions
Revises: 002_add_scoring_run_id
...
revision: str = '003_add_connector_permissions'
down_revision: Union[str, None] = '002_add_scoring_run_id'
branch_labels: Union[str, Sequence[str], None] = None
depends_on: Union[str, Sequence[str], None] = None


# Connector permissions to add
CONNECTOR_PERMISSIONS = [
    {"name": "connectors:read", "category": "connectors", "description": "View connector configurations"},
    {"name": "connectors:manage", "category": "connectors", "description": "Manage connector integrations"},
]


def upgrade() -> None:
    """Add connector permissions to the permissions table and assign to all roles."""
    conn = op.get_bind()

    # Step 1: Add connector permissions
    permission_ids = {}
    for perm in CONNECTOR_PERMISSIONS:
    ...
    # Step 3: Assign all connector permissions to every role
...
def downgrade() -> None:
    """Remove connector permissions from the permissions table."""
    conn = op.get_bind()
